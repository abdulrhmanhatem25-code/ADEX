...
/**
 * Panel for injected mandatory courses + Project courses (right sidebar).
 * Student can toggle each course on/off and pick lecture/lab sections.
 */
export default function InjectedCoursesPanel({
    courses,
